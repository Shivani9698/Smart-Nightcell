...
CPP_SRCS += \
../semaphore/semaphore_t.cpp 

OBJS += \
./semaphore/semaphore_t.o 

CPP_DEPS += \
./semaphore/semaphore_t.d 


# Each subdirectory must supply rules for building sources it contributes
semaphore/%.o semaphore/%.su semaphore/%.cyclo: ../semaphore/%.cpp semaphore/subdir.mk
...
clean: clean-semaphore

clean-semaphore:
	-$(RM) ./semaphore/semaphore_t.cyclo ./semaphore/semaphore_t.d ./semaphore/semaphore_t.o ./semaphore/semaphore_t.su

.PHONY: clean-semaphore
